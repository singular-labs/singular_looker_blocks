- dashboard: campaign_drilldown
  ...
  - title: Sub Campaigns Breakdown
    ...
    fields: [marketing_data.impressions, marketing_data.ctr, marketing_data.clicks,
      ...
      marketing_data.cpm, marketing_data.adn_sub_campaign_name]
    filters:
      marketing_data.adn_sub_campaign_name: "-NULL"
      marketing_data.cost: ">0,NOT NULL"
    sorts: [marketing_data.cost desc]
    limit: 500
    column_limit: 50
    show_view_names: false
  ...
  - name: Campaign
    title: Campaign
    type: field_filter
    default_value: '"NA_Analytics TOF_Broad"'
    allow_multiple_values: true
    required: false
    model: singular_block
    explore: marketing_data
